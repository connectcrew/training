...
@WebServlet("/illustrator_list")
public class Illustrator_list extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		GetPageIlLogic pageNum = new GetPageIlLogic();
		...
		request.setAttribute("ilList", ilList);

		/* フォワード */
		RequestDispatcher dispatcher =
				request.getRequestDispatcher("/WEB-INF/pages/illustrator_list.jsp");
