...
import model.Engine;
import model.GetEngineListLogic;
import model.GetPageSeriesLogic;

@WebServlet("/engine_list")
public class Engine_list extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		GetEngineListLogic getEngineListLogic = new GetEngineListLogic();
		List<Engine> engineList = getEngineListLogic.execute(searchName, searchPage);
		request.setAttribute("engineList", engineList);

		/* フォワード */
		RequestDispatcher dispatcher =
				request.getRequestDispatcher("/WEB-INF/pages/engine_list.jsp");
