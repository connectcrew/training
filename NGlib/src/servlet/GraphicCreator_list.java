...
@WebServlet("/GraphicCreator_list")
public class GraphicCreator_list extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		GetPageGCLogic pageNum = new GetPageGCLogic();
		...
		RequestDispatcher dispatcher =
				request.getRequestDispatcher("/WEB-INF/pages/graphic_creator_list.jsp");
