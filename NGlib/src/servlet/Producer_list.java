...
@WebServlet("/producer_list")
public class Producer_list extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		GetPagePrLogic pageNum = new GetPagePrLogic();
		...
		RequestDispatcher dispatcher =
				request.getRequestDispatcher("/WEB-INF/pages/producer_list.jsp");
