...
import model.Series;
import model.GetSeriesListLogic;
import model.GetPageSeriesLogic;

@WebServlet("/series_list")
public class Series_list extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		GetSeriesListLogic getSeriesListLogic = new GetSeriesListLogic();
		List<Series> seriesList = getSeriesListLogic.execute(searchName, searchPage);
		...
		RequestDispatcher dispatcher =
				request.getRequestDispatcher("/WEB-INF/pages/series_list.jsp");
