...
@WebServlet("/SoundCreator_list")
public class SoundCreator_list extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		GetPageSCLogic pageNum = new GetPageSCLogic();
		...
		RequestDispatcher dispatcher =
				request.getRequestDispatcher("/WEB-INF/pages/sound_creator_list.jsp");
